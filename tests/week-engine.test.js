...
const training = require("../training-engine.js");
const migration = require("../career-migration.js");
const week = require("../week-engine.js");
...
test("une capsule migrée devient une enveloppe indépendante sans réécrire son snapshot de rollback", () => {
  ...
  const capsule = migration.migrateToCareerCapsule(source, { migratedAt: "2026-01-01T00:00:00Z" });
