...
Chaque niveau conserve trois points de caractéristiques. Les niveaux ordinaires ajoutent une rotation déterministe de cadeaux du coach — 50 $, un supplément ou un bon couvrant la prochaine séance privée — tandis que les niveaux 5, 10 et 15 accordent l'augmentation de capacité.
...
Les forfaits privés n'existent plus. Chaque réservation couvre exactement une séance au plein prix : 120 $ avec l'entraîneur du club, 200 $ avec le spécialiste et 320 $ avec l'entraîneur élite. Le GYM de boxe propose Olivier Martel, Maude Lavoie et Hector Vargas pour Technique ou Défense; le gym de musculation propose Kim Nguyen, Darnell Brooks et Valérie Fortin pour Puissance ou Cardio. Les anciennes données de forfait multi-séances sont retirées à la normalisation et ne produisent aucun compteur de séances restantes.

Une réservation réussit seulement si le joueur possède à la fois le prix demandé et la capacité hebdomadaire nécessaire. Lorsqu'un bon gratuit est disponible, un bandeau visible l'annonce avant le choix, chaque prix passe clairement à 0 $ et la confirmation rappelle que le solde restera inchangé. La confirmation présente le prix, l'XP ciblée estimée, l'énergie, la fatigue et la capacité; le débit et l'ajout au programme forment une seule transaction. Retirer la séance avant de confirmer la semaine rembourse le prix ou rend le bon. Une seule séance privée peut être placée dans une même semaine. Elle réserve l'énergie hebdomadaire de sa famille et une journée physique distincte lors de l'exécution. La progression exécutée par l'horloge est l'unique autorité : aucun état parallèle ne peut accorder une deuxième progression.
...
Les suppléments sont achetés à la boutique du gym de musculation et apparaissent dans l'onglet Inventaire séparé de la fiche Boxeur. Sélectionner un produit ouvre d'abord une confirmation qui résume son effet, sa limite, son prix, le solde avant et après ainsi que l'inventaire avant et après. Aucun débit n'a lieu avant la confirmation et l'achat ajoute seulement le produit à l'inventaire sans l'utiliser ni le réserver. Lorsqu'une séance physique admissible est ajoutée, le jeu propose immédiatement les produits possédés, leur effet réel sur la capacité et l'option de continuer sans produit; l'Inventaire permet toujours de faire ou modifier cette association plus tard. Cette proposition couvre la boxe, la musculation, les entraînements maison, la course et les séances privées, mais jamais le travail, les repas, le repos, le sparring ou les combats. Le joueur peut en réserver au plus un par séance, pour un maximum de deux utilisations par semaine et une utilisation d'un même produit par semaine. La barre hebdomadaire est recalculée depuis le même effet d'énergie et de fatigue qui sera appliqué pendant la séance : aucun bonus arbitraire n'est ajouté une deuxième fois. Les produits ne modifient jamais directement l'XP, le stimulus ni une statistique. Si la semaine ou la séance échoue, la transaction entière est annulée et le produit demeure dans l'inventaire.
